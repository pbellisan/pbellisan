...
### Full-Stack Developer | Infrastructure Enthusiast | AI Integrator | Academic Editor

Yazılım dünyasında sadece kod yazmaya değil, uçtan uca çalışan, güvenli ve ölçeklenebilir sistemler kurmaya odaklanıyorum. Docker konteyner mimarileri, Nginx güvenlik katmanları ve yapay zeka entegrasyonları ile modern çözümler üretiyorum.

---

### 🛠️ Teknolojik Altyapı & Araç Seti
...
* **Infrastructure as Code:** Tüm projelerimi Docker ve Nginx üzerine inşa ediyor, local-to-production süreçlerini tek komutla yönetiyorum.
* **AI Implementation:** Gemini AI API kullanarak müşteri deneyimini otomatize eden akıllı asistanlar geliştiriyorum.
* **Secure Payments:** Stripe entegrasyonları ile global standartlarda ödeme ve abonelik sistemleri kuruyorum.
...
<p align="left">
  <!-- GitHub Readme Stats - Stabil Alternatif Giriş -->
  <img src="https://github-readme-stats-sigma-five.vercel.app/api?username=pbellisan&show_icons=true&theme=dark&include_all_commits=true" alt="Parla's GitHub Stats" />
  
  <br/><br/>
  
  <!-- En Çok Kullanılan Diller -->
  <img src="https://github-readme-stats-sigma-five.vercel.app/api/top-langs/?username=pbellisan&layout=compact&theme=dark" alt="Top Langs" />
</p>
---
...
### 🚀 Neler Yapıyorum? (Mühendislik + Araştırma)
* **Performance Benchmarking:** Büyük veri ortamlarında Python ile yazılım performansı analizi ve optimizasyon testleri.
